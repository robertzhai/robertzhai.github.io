webpackJsonp([9], {
    0: function (r, t, e) {
        ...
        function u() {
            ...
            w = r - 40;
            var t = w / 1008 * 640 + 50;
            (0, g["default"])(".pcviewer-previewarea").css({
                height: w,
                width: t
            }), (0, g["default"])(".pcviewer-previewarea-iframe").css({height: w - 20, width: 640 * (w - 20) / 1008});
            var e = t / 1.6 + 185;
            (0, g["default"])(".pcviewer").css({"margin-left": -e})
        }

        function f() {
            document.getElementById("previewiframe").contentWindow.location.reload(!0), u()
        }

        var c = e(2), g = n(c), v = e(84), h = n(v), l = e(1), s = n(l);
        e(82);
        var w, d = "http://" + window.location.host + '/invite/preview.html';
        if (s["default"].judgePC()) {
            window.onresize = f, u();
            var y = "http://" + window.location.host + "/k/" + window.projectVersion.id, p = h["default"].toDataURL(y, 8);
            (0, g["default"])(".pcviewer-infoarea-qrcodearea-img").eq(0).attr("src", p), (0, g["default"])(".pcviewer-previewarea-downBtn").on("click", function () {
                i()
            }), (0, g["default"])(".pcviewer-previewarea-upBtn").on("click", function () {
                a()
            })
        ...
        var n = e(85);
        r.exports = {
            typeNumber: 4, errorCorrectLevel: "L", toBase64: function (r, t) {
                var e = n(this.typeNumber, this.errorCorrectLevel);
                e.addData(r), e.make();
                var o = e.createImgBase64(t);
                return o
            }, toDataURL: function (r, t) {
                var e = this.toBase64(r, t), n = "data:image/gif;base64," + e;
                return n
            }
        }
    }, 85: function (r, t) {
        var e = function () {
            ...
            var t = function (t, e) {
                var o = 236, i = 17, g = t, v = n[e], h = null, l = 0, d = null, y = new Array, p = {}, B = function (r, t) {
                    l = 4 * g + 17, h = function (r) {
                        for (var t = new Array(r), e = 0; r > e; e += 1) {
                            t[e] = new Array(r);
                            for (var n = 0; r > n; n += 1)t[e][n] = null
                        }
                        return t
                    }(l), A(0, 0), A(l - 7, 0), A(0, l - 7), T(), M(), D(r, t), g >= 7 && m(r), null == d && (d = L(g, v, y)), k(d, t)
                }, A = function (r, t) {
                    ...
                    for (var e = v << 3 | t, n = a.getBCHTypeInfo(e), o = 0; 15 > o; o += 1) {
                        var i = !r && 1 == (n >> o & 1);
                    ...
                    for (var e = -1, n = l - 1, o = 7, i = 0, u = a.getMaskFunction(t), f = l - 1; f > 0; f -= 2)for (6 == f && (f -= 1); ;) {
                        for (var c = 0; 2 > c; c += 1)if (null == h[n][f - c]) {
                            var g = !1;
                            i < r.length && (g = 1 == (r[i] >>> o & 1));
                            var v = u(n, f - c);
                            v && (g = !g), h[n][f - c] = g, o -= 1, -1 == o && (i += 1, o = 7)
                        }
                        if (n += e, 0 > n || n >= l) {
                            n -= e, e = -e;
                            break
                    ...
                    for (var n = 0, o = 0, i = 0, u = new Array(e.length), f = new Array(e.length), c = 0; c < e.length; c += 1) {
                        var g = e[c].dataCount, v = e[c].totalCount - g;
                        o = Math.max(o, g), i = Math.max(i, v), u[c] = new Array(g);
                        for (var h = 0; h < u[c].length; h += 1)u[c][h] = 255 & t.getBuffer()[h + n];
                        n += g;
                        var l = a.getErrorCorrectPolynomial(v), s = r(u[c], l.getLength() - 1), w = s.mod(l);
                    ...
                    for (var y = 0, h = 0; h < e.length; h += 1)y += e[h].totalCount;
                    ...
                    for (var n = u.getRSBlocks(r, t), c = f(), g = 0; g < e.length; g += 1) {
                        var v = e[g];
                        c.put(v.getMode(), 4), c.put(v.getLength(), a.getLengthInBits(v.getMode(), r)), v.write(c)
                    }
            ...
            t.stringToBytes = function (r) {
                ...
                var e = function () {
                    for (var e = h(r), n = function () {
                        ...
                        var i = e.read();
                        if (-1 == i)break;
                        var u = n(), f = n(), c = n(), g = String.fromCharCode(i << 8 | u), v = f << 8 | c;
                        a[g] = v, o += 1
                    }
            ...
            var e = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, n = {
                ...
                return f.getBCHTypeInfo = function (r) {
                    ...
                    for (var g = 0, o = 0; t > o; o += 1)for (var n = 0; t > n; n += 1)r.isDark(n, o) && (g += 1);
                ...
                var r = [[1, 26, 19], [1, 26, 16], [1, 26, 13], [1, 26, 9], [1, 44, 34], [1, 44, 28], [1, 44, 22], [1, 44, 16], [1, 70, 55], [1, 70, 44], [2, 35, 17], [2, 35, 13], [1, 100, 80], [2, 50, 32], [2, 50, 24], [4, 25, 9], [1, 134, 108], [2, 67, 43], [2, 33, 15, 2, 34, 16], [2, 33, 11, 2, 34, 12], [2, 86, 68], [4, 43, 27], [4, 43, 19], [4, 43, 15], [2, 98, 78], [4, 49, 31], [2, 32, 14, 4, 33, 15], [4, 39, 13, 1, 40, 14], [2, 121, 97], [2, 60, 38, 2, 61, 39], [4, 40, 18, 2, 41, 19], [4, 40, 14, 2, 41, 15], [2, 146, 116], [3, 58, 36, 2, 59, 37], [4, 36, 16, 4, 37, 17], [4, 36, 12, 4, 37, 13], [2, 86, 68, 2, 87, 69], [4, 69, 43, 1, 70, 44], [6, 43, 19, 2, 44, 20], [6, 43, 15, 2, 44, 16]], t = function (r, t) {
                    var e = {};
                ...
                return e.getRSBlocks = function (r, e) {
                    ...
                    for (var a = n.length / 3, i = new Array, u = 0; a > u; u += 1)for (var f = n[3 * u + 0], c = n[3 * u + 1], g = n[3 * u + 2], v = 0; f > v; v += 1)i.push(t(c, g));
                    return i
                }, e
            }(), f = function () {
                ...
                var i = function (r) {
                    ...
                    var c = g(), v = i(c);
                    v.write(t, n);
                    var h = 0, l = String.fromCharCode(o[h]);
                    for (h += 1; h < o.length;) {
                        var s = String.fromCharCode(o[h]);
                        h += 1, a.contains(l + s) ? l += s : (v.write(a.indexOf(l), n), a.size() < 4095 && (a.size() == 1 << n && (n += 1), a.add(l + s)), l = s)
                    }
                    return v.write(a.indexOf(l), n), v.write(e, n), v.flush(), c.toByteArray()
                }, f = function () {
                    var r = {}, t = 0, e = {};
